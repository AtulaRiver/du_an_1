                        ...
                        <div class="con">
                            ...
                            <div class="row facilities">
                                ...
                                <div class="col col-md-5 text-end">
                                    <div class="permalink"><a href="room-details.html">Chi tiết <i
                ...
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <h4>Nhà Hàng</h4>
                            <p style="text-align: justify;">Với không gian đẹp mắt, không khí ấm cúng và thực đơn phong
                                phú, chúng tôi hân hạnh đem
                                đến cho bạn trải nghiệm ẩm thực đa dạng và tuyệt vời. Tại BGV Hotel, chúng tôi tận tâm
                                phục vụ từng món ăn với đội ngũ nhân viên chuyên nghiệp và tận tâm.</p>
                            <div class="butn-dark"> <a href="restaurant.html"><span>Xem thêm</span></a> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 bg-cream p-0 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <h4>Trung Tâm Spa</h4>
                            <p style="text-align: justify;">Chúng tôi tự hào mang đến cho quý khách trải nghiệm thư giãn
                                tuyệt vời và phục hồi sức
                                khỏe hoàn hảo tại Trung tâm Spa của chúng tôi. Với không gian yên tĩnh, trang thiết bị
                                hiện đại và đội ngũ chuyên nghiệp, chúng tôi cam kết đem đến cho bạn một cuộc sống đầy
                                năng lượng và cân bằng.</p>
                            <div class="butn-dark"> <a href="spa-wellness.html"><span>Xem thêm</span></a> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <h4>Trung Tâm Fitness</h4>
                            <p style="text-align: justify;">Chúng tôi tự hào giới thiệu một không gian thể dục hiện đại
                                và đầy đủ tiện nghi, được
                                thiết kế để đáp ứng mọi nhu cầu của bạn về sức khỏe và thể chất. Chúng tôi cam kết cung
                                cấp một môi trường thân thiện và đầy đủ động lực,
                                giúp bạn duy trì lối sống lành mạnh dù đang trong chuyến công tác hay du lịch.</p>
                            <div class="butn-dark"> <a href="spa-wellness.html"><span>Xem thêm</span></a> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 bg-cream p-0 order2 valign animate-box" data-animate-effect="fadeInLeft">
                    <div class="content">
                        <div class="cont text-left">
                            ...
                            <h4>Sức Khoẻ & Bể Bơi</h4>
                            <p style="text-align: justify;">Chúng tôi tự hào giới thiệu không gian thể dục hiện đại cùng
                                hồ bơi tuyệt vời, nơi bạn có
                                thể thư giãn và tái tạo năng lượng sau một ngày dày công hoặc du lịch thú vị. Với thiết
                                kế sang trọng và trang thiết bị tiên tiến, chúng tôi cam kết đem đến cho bạn trải nghiệm
                                thể dục và thư giãn tối đa.</p>
                            <div class="butn-dark"> <a href="spa-wellness.html"><span>Xem thêm</span></a> </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="booking-box">
                            ...
                            <div class="booking-inner clearfix">
                                <form action="https://duruthemes.com/demo/html/BGV/demo1-light/rooms2.html"
